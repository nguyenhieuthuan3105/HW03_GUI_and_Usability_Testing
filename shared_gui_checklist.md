# Shared GUI Checklist - Group Deliverable

> [!NOTE]
> File checklist này được thiết kế và thống nhất bởi các thành viên trong nhóm, bao phủ tối thiểu 40 mục kiểm thử thuộc 4 khía cạnh giao diện (IA-01 đến IA-04).

## Bảng Checklist GUI Tổng Hợp

| ID | Khía Cạnh | Mục Kiểm Tra (Checklist Item Description) | Ánh Xạ Heuristics / Nguyên Tắc | Screen B1 (Pass/Fail/NA) | Screen B2 (Pass/Fail/NA) | Screen B3 (Pass/Fail/NA) | Screen B4 (Pass/Fail/NA) | Ghi Chú Lỗi (Notes) |
|---|---|---|---|---|---|---|---|---|
...
| IA-01-08 | General UI | Các hình ảnh (Thumbnail/Banner) không bị méo tỉ lệ hiển thị (aspect ratio 4:3, 24:9). | Shneiderman: Aesthetics | | | | | |
...
| IA-03-06 | Navigation | Tính năng kéo thả thay đổi thứ tự (Reorder) hiển thị trực quan (dòng bị kéo mờ đi). | Norman: Feedback | | | | | |
...
| IA-04-04 | Feedback | Huy hiệu (Badges) hiển thị chính xác số lượng thông báo hoặc trạng thái của vé. | Nielsen #1: Visibility | | | | | |
